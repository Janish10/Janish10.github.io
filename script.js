    ...
    if (result.success) {
      form.innerHTML = `
        <div style="text-align:center;padding:40px 20px">
          ...
          <p style="color:var(--text-muted);font-size:0.9rem">Thanks for reaching out — I'll get back to you within 24 hours.</p>
        </div>`;
    } else {
      throw new Error();
    }
...
// ── Subtle terminal cursor blink on hero tagline ──
